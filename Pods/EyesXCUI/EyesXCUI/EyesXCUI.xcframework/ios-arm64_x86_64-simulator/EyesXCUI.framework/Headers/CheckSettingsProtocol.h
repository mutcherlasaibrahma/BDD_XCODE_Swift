...
/**
 ...
 @return This instance of the settings object.
 */
- (id<CheckSettingsProtocol>)fully:(BOOL)fully;
...
/**
 Defines the period of time before capturing.
 @param waitBeforeCapture Period of time before capturing in ms.
 @return This instance of the settings object.
 */
- (id<CheckSettingsProtocol>)waitBeforeCapture:(NSUInteger)waitBeforeCapture;
